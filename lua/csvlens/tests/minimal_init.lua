local plenary_dir = os.getenv("PLENARY_DIR") or "/tmp/csvlens_test/plenary.nvim"
...
local toggleterm_dir = os.getenv("TOGGLETERM_DIR") or "/tmp/csvlens_test/toggleterm.nvim"
